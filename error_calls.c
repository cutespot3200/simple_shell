...
/**
 * err_env - Makes an error message for shello_env errors.
...
/**
 * err_1 - Makes err message for shello_alias errors.
 * @args: Array of args passed to the command.
 *
 * Return: Error string.
 */
...
/**
 * err_2_exit - Makees error message for shello_exit errors.
 * @args: Array of args passed to the command.
 *
 * Return: Error string.
 */
...
/**
 * err_2_cd - Makes error message for shello_cd errors.
 * @args: Array of args passed to the command.
 *
 * Return: Error string.
 */
...
/**
 * err_2_syntax - Makes error message for syntax errors.
 * @args: Array of args passed to the command.
 *
 * Return: Error string.
 */
